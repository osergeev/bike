...
wheel1 = mpl.Circle((0,0), radius=elems[2].r)
axes.add_patch(wheel1)
wheel1.center = (elems[2].x,elems[2].y)
wheel2 = mpl.Circle((0,0), radius=elems[3].r)
wheel2.center = (elems[3].x,elems[3].y)
axes.add_patch(wheel2)
point1 = mpl.Circle((0,0), radius=0.3)
...
#	outfile.write(text)
	...
	if nsteps % 10 == 0:
		...
		point1.center = (elems[0].x,elems[0].y)
		point2.center = (elems[1].x,elems[1].y)
		#spr1.set_xdata([elems[2].x,elems[3].x,,xp2,xw2])
		#spr2.set_xdata([xp2,xw1,xp1])
		time_text.set_text('time = %.1f' % t)
		#dist_text.set_text('distance = %.3f' % i)
		axes.set_xlim(t-1,t+8)
		#mpl.title()
		mpl.draw()
